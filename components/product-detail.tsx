...
export function ProductDetail({ product }: ProductDetailProps) {
  ...
  return (
    ...
    >
      {/* Left Column */}
      <div className="flex flex-col justify-between w-full lg:w-[55%] p-4 sm:p-6 md:p-8 lg:p-12 pt-12 sm:pt-16 lg:pt-20 bg-transparent">
        {/* Product Content */}
      ...
      <div className="w-full lg:w-[45%] flex lg:items-start items-center justify-center p-4 lg:p-4 lg:pr-8 order-first lg:order-last lg:pt-8">
        {imageUrl ? (
          <Image
            alt={product.name}
