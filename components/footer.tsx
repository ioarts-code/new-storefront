...
function FooterWFull() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] h-[532px] min-h-[532px] relative rounded-[12px] shrink-0 w-[99%] sm:w-[98.5%] md:w-[98%] lg:w-[97.5%] xl:w-[97%] mx-auto" data-name="footer.w-full">
