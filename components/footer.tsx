...
function DivAbsolute2() {
  return (
    <div className="absolute content-stretch flex flex-col items-end right-[44px] mobile:right-[32px] mobile:bottom-[16px] tablet:top-[480px] mobile:w-auto" data-name="div.absolute">
