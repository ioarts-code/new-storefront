...
function FooterWFull() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] h-[532px] min-h-[532px] relative rounded-[12px] shrink-0 w-[98.5%] sm:w-[98%] md:w-[98%] lg:w-[97.5%] xl:w-[97%] mx-auto" data-name="footer.w-full">
      <div aria-hidden="true" className="absolute border-3 border-solid border-[#a2a2a2] inset-0 pointer-events-none rounded-[12px]" />
      <div className="-translate-y-1/2 absolute flex flex-col font-bold h-[349px] justify-center leading-[0] left-[44px] not-italic text-[clamp(3rem,8vw,8rem)] md:text-[clamp(4rem,10vw,10rem)] lg:text-[clamp(5rem,12vw,12rem)] xl:text-[clamp(7rem,16vw,18rem)] text-[#a2a2a2] top-[40px] sm:top-[218.5px] w-[calc(100%-88px)] md:w-[min(70vw,500px)] lg:w-[min(75vw,800px)] xl:w-[1079.975px] max-w-full overflow-hidden whitespace-nowrap rotate-90 origin-left sm:rotate-0 sm:origin-center">
