...
export default function Hero({
  ...
  return (
    <div className="relative">
      <div className="relative lg:h-[800px] mobile:h-[650px] flex items-center justify-center overflow-hidden w-screen cursor-pointer" onClick={() => router.push('/products/hoodie-elden')}>
