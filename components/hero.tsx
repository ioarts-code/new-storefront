...
export default function Hero({
  ...
  return (
    <div className="relative">
      <div className="relative lg:h-[800px] mobile:h-[650px] flex items-start justify-center overflow-hidden w-screen cursor-pointer" onClick={() => router.push('/products/hoodie-elden')}>
      ...
      {showFeaturedCard && (
        <>
          {featuredCardLoading ? (
            ...
            <div className="absolute md:hidden top-6 right-6 sm:top-8 sm:right-8 md:top-10 md:right-10 lg:top-20 lg:right-20 flex flex-col items-start p-4 sm:p-6 md:p-7 lg:p-8 w-56 sm:w-72 md:w-80 lg:w-96 bg-transparent rounded-lg gap-2 sm:gap-4 z-10">
