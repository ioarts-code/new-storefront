          ...
          {featuredCardLoading ? (
            ...
            <div className="absolute top-16 md:top-24 lg:top-40 left-6 md:left-10 lg:left-[8%] xl:left-[14%] flex flex-col items-start p-4 sm:p-6 md:p-7 lg:p-8 w-56 sm:w-72 md:w-80 lg:w-96 bg-transparent rounded-lg gap-2 sm:gap-4 z-50">
              ...
              <Link
                ...
                className="hidden sm:flex px-6 sm:px-10 md:px-11 lg:px-12 py-2 sm:py-2.5 md:py-2.5 lg:py-3 border-3 border-white rounded-full text-white text-white hover:bg-green-200 hover:text-black font-bold text-xs sm:text-sm uppercase"
              >
                View
              </Link>
            </div>
